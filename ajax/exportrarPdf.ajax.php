...
<table style="font-family:tahoma;font-size:11;border:solid 1px black;" width="100%" cellpadding="3px" cellspacing="1px" width="100%">
    ...
    <tr>
        ...
        <th>APLICA AV-VILLAS</th>
    </tr>
    <tr>
        <td style="text-align:center;">'.mb_strtoupper($key['pri_desc_v']).'</td>
        <td style="text-align:center;">'.$key['desc_tps_v'].'</td>
        <td style="text-align:center;">'.$aplica.'</td>
    </tr>
</table>
<br/>
<table style="font-family:tahoma;font-size:11;border:solid 1px black;" width="100%" cellpadding="3px" cellspacing="1px" width="100%">
